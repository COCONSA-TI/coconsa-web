    ...
    <section id="servicios" className="py-16 sm:py-24 bg-gray-50">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto">
          <p className="text-red-700 font-semibold">NUESTROS SERVICIOS</p>
        ...
        <div className="mt-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service) => (
            <div key={service.name} className="bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 flex flex-col">
              ...
              <div className="mt-6">
                <Link href={service.href} className="text-red-700 font-semibold hover:underline">
                  Ver más →
                </Link>
              </div>
            </div>
        ...
        <div className="mt-16 text-center">
          <Link href="/servicios" className="bg-red-600 text-white font-bold py-3 px-8 rounded-lg hover:bg-red-700 transition-colors duration-300 text-lg">
