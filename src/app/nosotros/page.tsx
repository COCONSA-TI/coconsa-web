    ...
    <main className="bg-white text-gray-800">
      ...
      <section className="py-16 bg-gray-50">
          <div className="container mx-auto px-4">
              ...
              <div className="relative max-w-2xl mx-auto">
                  <div className="absolute left-1/2 w-0.5 h-full bg-blue-300 transform -translate-x-1/2"></div>
                  {timelineEvents.map((event, index) => (
                      <div key={index} className="mb-8 flex justify-between items-center w-full">
                          ...
                          <div className="z-20 flex items-center order-2 bg-blue-600 shadow-xl w-8 h-8 rounded-full">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
                ...
                <div className="space-y-4">
                    {values.map(value => (
                        <div key={value.name}>
                            <h3 className="text-xl font-semibold text-blue-600">{value.name}</h3>
      ...
      <section className="bg-gray-900 text-white">
        <div className="container mx-auto text-center px-4 py-12">
          ...
          <Link href="/proyectos" className="bg-blue-600 font-bold py-3 px-8 rounded-lg hover:bg-blue-700 transition-colors">
            Explorar Proyectos
          </Link>
        </div>
      </section>
