...
<div className="container mx-auto px-4 py-16">
  <h1 className="text-6xl font-bold mb-16 text-black text-center tracking-tight">Solicitud de Cotización</h1>
  ...
  <form action={formAction} className="max-w-4xl mx-auto">
          ...
          <div key={item.id} className="flex justify-between items-center border border-gray-200 p-4 rounded-lg bg-gray-50 hover:bg-gray-100 transition-colors">
            ...
            <div className="flex items-center gap-4">
              ...
              <input
                ...
                className="w-16 p-1 border border-gray-300 rounded focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-black"
                min="1"
                max="10"
              />
    ...
    <div className="mb-12">
        <h2 className="text-2xl font-semibold mb-4 text-black">Fechas de Renta</h2>
    ...
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div>
          ...
          <input type="text" id="name" name="name" required className="text-black w-full p-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500" />
          {state.errors?.name && <p className="text-red-500 text-sm mt-1">{state.errors.name[0]}</p>}
        </div>
        <div>
          <label htmlFor="company" className="block mb-2 font-medium text-black">Empresa (Opcional)</label>
          <input type="text" id="company" name="company" className="text-black w-full p-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500" />
          {state.errors?.company && <p className="text-red-500 text-sm mt-1">{state.errors.company[0]}</p>}
        </div>
        <div>
          <label htmlFor="email" className="block mb-2 font-medium text-black">Correo Electrónico</label>
          <input type="email" id="email" name="email" required className="text-black w-full p-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500" />
        ...
        <div>
          ...
          <input type="tel" id="phone" name="phone" required pattern="[0-9]*" className="text-black w-full p-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500" />
