...
export async function POST(
  ...
  try {
    ...
    const matchesUserDeptReject = (a: OrderApprovalWithRelations) => {
    ...
    const myApproval = approvals.find((a) => matchesUserDeptReject(a) && a.status === 'pending')
      ?? approvals.find((a) => matchesUserDeptReject(a));
